<x-app-layout>
  <x-slot name="header">
    <x-page-header :title="'Nuova pizza'" :items="[['label'=>'Pizze','url'=>route('admin.pizzas.index')],['label'=>'Crea']]" :backUrl="route('admin.pizzas.index')" />
  </x-slot>
  ...
  <div class="row justify-content-center py-3">
    <div class="col-12 col-lg-10 col-xl-8">
      <div class="card shadow-sm">
        ...
        <div class="card-body">
          <form action="{{ route('admin.pizzas.store') }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="row g-3">
              ...
              <div class="col-12 col-md-3">
                ...
                <input id="price" name="price" type="number" step="0.01" class="form-control @error('price') is-invalid @enderror" value="{{ old('price') }}" required>
              ...
              <div class="col-12 col-md-6">
                ...
                <div class="form-text">JPG, PNG o WebP, max 2MB.</div>
              </div>
            </div>
