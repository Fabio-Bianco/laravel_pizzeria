              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-5 col-6">
                  <h6 class="mb-1 fw-bold">
                    <a href="<?php echo e(route('admin.pizzas.show', $p)); ?>" class="text-decoration-none text-dark">
                      <?php echo e($p->name); ?>

                    </a>
                  </h6>
                  <small class="text-muted d-block"><?php echo e($p->notes ?? 'Nessuna descrizione'); ?></small>
                  ...
                  <?php if(!empty($p->ingredients) && $p->ingredients->isNotEmpty()): ?>
                    <div class="mt-1">
                      <small class="text-muted">
                        ...
                        <?php echo e($p->ingredients->take(3)->pluck('name')->join(', ')); ?>

                        <?php if($p->ingredients->count() > 3): ?>
                          <span class="badge bg-info text-white ms-1" style="font-size: 10px;">
                            +<?php echo e($p->ingredients->count() - 3); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.allergen-display','data' => ['allergens' => $p,'mode' => 'minimal','maxVisible' => 3]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['allergens' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($p),'mode' => 'minimal','maxVisible' => 3]); ?>
...
<?php endif; ?>
                ...
                <div class="col-md-2 col-3 text-center">
                  <span class="h6 text-success fw-bold">€<?php echo e(number_format($p->price ?? 0, 2, ',', '.')); ?></span>
                ...
                <div class="col-md-3 col-12 mt-2 mt-md-0">
                  <div class="btn-group btn-group-sm w-100">
                    <a href="<?php echo e(route('admin.pizzas.show', $p)); ?>" class="btn btn-view btn-sm flex-fill">
                      <i class="fas fa-eye me-1" aria-hidden="true"></i>
                      <span class="d-none d-sm-inline">Dettagli</span>
                    </a>
                    <a href="<?php echo e(route('admin.pizzas.edit', $p)); ?>" class="btn btn-edit btn-sm flex-fill">
                      <i class="fas fa-edit me-1" aria-hidden="true"></i>
                      <span class="d-none d-sm-inline">Modifica</span>
                    </a>
                    <form method="POST" action="<?php echo e(route('admin.pizzas.destroy', $p)); ?>" class="flex-fill d-inline"
              ...
              <div class="card h-100 border-0 shadow-sm">
                ...
                <div class="card-body d-flex flex-column">
                      ...
                      <div class="d-flex flex-wrap gap-1">
                        ...
                        <?php if($p->ingredients->count() > 4): ?>
                          <span class="badge bg-info text-white" 
                                role="button"
                                tabindex="0"
                                title="Altri <?php echo e($p->ingredients->count() - 4); ?> ingredienti non mostrati"
                                aria-label="Mostra altri <?php echo e($p->ingredients->count() - 4); ?> ingredienti di <?php echo e($p->name); ?>">
                            <i class="fas fa-plus me-1" aria-hidden="true"></i><?php echo e($p->ingredients->count() - 4); ?>
                  ...
                  <div class="mb-3">
                    <?php if (isset($component)) { $__componentOriginal5b439834db70954e0d348c0a339254ee = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal5b439834db70954e0d348c0a339254ee = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.allergen-display','data' => ['allergens' => $p,'mode' => 'compact','maxVisible' => 3]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('allergen-display'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['allergens' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($p),'mode' => 'compact','maxVisible' => 3]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal5b439834db70954e0d348c0a339254ee)): ?>
<?php $attributes = $__attributesOriginal5b439834db70954e0d348c0a339254ee; ?>
