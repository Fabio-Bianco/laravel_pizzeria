...
unset($__errorArgs, $__bag); ?>
                                        <?php if($appetizer->image): ?>
                                            <div class="form-text">Immagine attuale: <?php echo e(basename($appetizer->image)); ?></div>
                                        <?php endif; ?>
                                    </div>
...
unset($__errorArgs, $__bag); ?>" 
                                                  placeholder="Note aggiuntive..."><?php echo e(old('notes', $appetizer->notes)); ?></textarea>
...
<?php echo $__env->make('layouts.app-modern', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Utente\Desktop\project-work\pizzeria-backend\resources\views/admin/appetizers/edit.blade.php ENDPATH**/ ?>